...
typerCssArray.push(args => {
  ...
  let currentWordNotWrong = inputWords.length <= verseWords.length && getTransformedWord(args, verseWords[inputWords.length - 1]).indexOf(getTransformedWord(args, inputWords[inputWords.length - 1])) !== -1;
